        ...
        <div class="col-lg-7">
          <div class="p-5">
            <div class="text-center">
              <h1 class="h4 @if(App\Models\User::getAppTheme() == true) text-gray-100 @else text-gray-900 @endif mb-4">Të dhënat e vizitës</h1>
            </div>
            <table class="table table-striped ">
                    <tbody>
                        <tr>
                            <th>Pacienti:</th>
                            <td scope="row"><a class="btn btn-circle btn-secondary btn-sm" href="/pacient/{{$visit->pacient_id}}"><i class="fa fa-user"></i></a> {{App\Models\Pacient::getPacient($visit->pacient_id)}}</td>
                        </tr>
                        <tr>
                            <th>Dentisti:</th>
                            <td scope="row"><a class="btn btn-circle btn-secondary btn-sm" href="/user/{{$visit->user_id}}"><i class="fa fa-user-md"></i></a> {{App\Models\User::getUser($visit->user_id)}}</td>
                        </tr>
