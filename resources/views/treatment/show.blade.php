        ...
        <div class="col-lg-7">
          <div class="p-5">
            <div class="text-center">
              <h1 class="h4 @if(App\Models\User::getAppTheme() == true) text-gray-100 @else text-gray-900 @endif mb-4">Të dhënat e trajtimit</h1>
            </div>
            <table class="table table-striped ">
                    <tbody>
                        <tr>
                            <th>Pacienti:</th>
                            <td scope="row"><a class="btn btn-circle btn-secondary btn-sm" href="/pacient/{{$treatment->pacient_id}}"><i class="fa fa-user"></i></a> {{App\Models\Pacient::getPacientName($treatment->pacient_id)}}</td>
                        </tr>
